		...
		<section class="content">
			<div class="container">
				<div class="row">
					...
					<form method="POST" action="{{ route('admin.pages.update', $item->id) }}" style="width: 60%;
					margin: 0
					auto">
						@csrf
						@method('put')
						<div class="row">
							<div class="col-12 mb-3">
								...
								<input class="form-control" id="exampleInputEmail1" name="uri"
								       value="{{ $item->uri }}">
							</div>
							<div class="col-12 mb-3">
							...
							<div class="col-12 mb-3">
								...
								<textarea name="content" class="edit_content" cols="31" rows="10">{{$item->content}}</textarea>
							</div>
