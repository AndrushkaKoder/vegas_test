 ...
 * @method static \Kalnoy\Nestedset\QueryBuilder|Category sFirstLevel($first = true)
 * @method static \Kalnoy\Nestedset\QueryBuilder|BaseModel sSorted($order = 'asc')
 ...
 * @method static \Kalnoy\Nestedset\QueryBuilder|Category whereVisible($value)
...
class Category extends BaseModel
{
	...
	protected static function booted()
	{
		...
		static::creating(function ($category) {
			$category->attributes['slug'] = Str::slug($category->title);
		});
	}
